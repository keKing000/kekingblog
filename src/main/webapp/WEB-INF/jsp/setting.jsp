...
<script type="text/javascript">
	$(function() {
		...
		$("#content").load("/page/setblog",{"userId" : userId});
	...
	function setcollect(data){
		...
		$("#content").empty();
		$("#content").load("/page/setcollect",{"userId" : userId});
	}
	...
	function setup(data){
		...
		$(data).parent().addClass("active");
		$("#content").empty();
		$("#content").load("/page/setup",{"userId" : userId});
	}
	function setdraft(data){
		...
		$(data).parent().addClass("active");
		$("#content").empty();
		$("#content").load("/page/setdraft",{"userId" : userId});
	}
			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse"
					...
					<ul class="nav navbar-nav">
						...
						<li><a href="/page/editor.html"><span class="glyphicon glyphicon-pencil"
								aria-hidden="true"></span> 写博客</a></li>
						<li class="active"><a href="/page/setting.html"><span class="glyphicon glyphicon-user"
						...
						<c:if test="${user!=null }">
							<div class="dropdown" style="width: 50px;">
								<a href="#" class="dropdown-toggle" data-toggle="dropdown"
										...
										<img src="${user.userpic }" class="img-responsive userPic" />
									</a>
	...
	<div class="container" style="background-color: #FFF;">
		<div class="row">
			<ul class="nav nav-tabs">
				<li role="presentation" class="active"><a onclick="setblog(this);">我的博客</a></li>
				<li role="presentation"><a onclick="setcollect(this);">我的收藏</a></li>
				<li role="presentation"><a onclick="setdraft(this);">草稿箱</a></li>
				<li role="presentation"><a onclick="setup(this);">个人设置</a></li>
			</ul>
		</div>
